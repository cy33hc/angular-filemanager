(function (angular) {
    ...
    angular.module('FileManagerApp').config(['$translateProvider', function ($translateProvider) {
        ...
        $translateProvider.translations('en', {
            ...
            compress: 'Compress',
            install: 'Install',
            install_with_alldebrid: 'Install via AllDebrid',
            install_with_realdebrid: 'Install via Real-Debrid',
            install_enable_rpi: 'Install directly from URL',
            install_use_disk_cache: 'Enable caching on disk',
            ...
            error_installing: 'An error occurred installing the file',
            ...
            error_installing_url: 'An error occurred installing url',
        ...
        $translateProvider.translations('nl', {
            ...
            compress: 'Inpakken',
            install: 'Installeren',
            install_with_alldebrid: 'Installeren via AllDebrid',
            install_with_realdebrid: 'Installeren via Real-Debrid',
            install_enable_rpi: 'Rechtstreeks vanaf URL installeren',
            install_use_disk_cache: 'Schakel caching op schijf in',
            ...
            error_installing_url: 'Er is een fout opgetreden bij het installeren van de URL',
        ...
        $translateProvider.translations('he', {
            ...
            compress: 'כווץ',
            install: 'להתקין',
            install_with_alldebrid: 'התקן דרך AllDebrid',
            install_with_realdebrid: 'התקן דרך Real-Debrid',
            install_enable_rpi: 'התקן ישירות מ-URL',
            install_use_disk_cache: 'אפשר אחסון במטמון בדיסק',
            ...
            error_installing_url: 'אירעה שגיאה בהתקנת URL',
        ...
        $translateProvider.translations('pt', {
            ...
            compress: 'Comprimir',
            install: 'Instalar',
            install_with_alldebrid: 'Instalar via AllDebrid',
            install_with_realdebrid: 'Instalar via Real-Debrid',
            install_enable_rpi: 'Instalar directamente desde la URL',
            install_use_disk_cache: 'Habilitar cache no disco',
            ...
            error_installing_url: 'Ocorreu um erro ao instalar o URL',
        ...
        $translateProvider.translations('es', {
            ...
            compress: 'Comprimir',
            install: 'Instalar',
            install_with_alldebrid: 'Instalar a través de AllDebrid',
            install_with_realdebrid: 'Instalar a través de Real-Debrid',
            install_enable_rpi: 'Instalar directamente desde la URL',
            install_use_disk_cache: 'Habilitar el almacenamiento en caché en el disco',
            ...
            error_installing_url: 'Ocurrió un error al instalar la URL',
        ...
        $translateProvider.translations('fr', {
            ...
            compress: 'Compresser',
            install: 'Installer',
            install_with_alldebrid: 'Installer via AllDebrid',
            install_with_realdebrid: 'Installer via Real-Debrid',
            install_enable_rpi: 'Installer directement à partir de l\'URL',
            install_use_disk_cache: 'Activer la mise en cache sur le disque',
            ...
            error_installing_url: 'Une erreur s\'est produite lors de l\'installation de l\'URL',
        ...
        $translateProvider.translations('de', {
            ...
            install_with_alldebrid: 'Installation über AllDebrid',
            install_with_realdebrid: 'Installation über Real-Debrid',
            install_enable_rpi: 'Direkt von der URL installieren',
            install_use_disk_cache: 'Aktivieren Sie das Caching auf der Festplatte',
            ...
            error_installing_url: 'Beim Installieren der URL ist ein Fehler aufgetreten',
        ...
        $translateProvider.translations('sk', {
            ...
            install: 'Inštalácia',
            install_with_alldebrid: 'Nainštalujte cez AllDebrid',
            install_with_realdebrid: 'Nainštalujte cez Real-Debrid',
            install_enable_rpi: 'Nainštalujte priamo z adresy URL',
            install_use_disk_cache: 'Povoliť ukladanie do vyrovnávacej pamäte na disku',
            ...
            error_installing_url: 'Pri inštalácii adresy URL sa vyskytla chyba',
        ...
        $translateProvider.translations('zh_cn', {
            ...
            compress: '压缩',
            install: '安装',
            install_with_alldebrid: '通过 AllDebrid 安装',
            install_with_realdebrid: '通过 Real-Debrid 安装',
            install_enable_rpi: '直接从 URL 安装',
            install_use_disk_cache: '启用磁盘缓存',
            ...
            error_installing_url: '安装 URL 时出错',
        ...
        $translateProvider.translations('zh_tw', {
            ...
            compress: '壓縮',
            install: '安裝',
            install_with_alldebrid: '通過 AllDebrid 安裝',
            install_with_realdebrid: '通過 Real-Debrid 安裝',
            install_enable_rpi: '直接從 URL 安裝',
            install_use_disk_cache: '啟用磁碟快取',
            ...
            error_installing_url: '安裝 URL 時出錯',
        ...
        $translateProvider.translations('ru', {
            ...
            compress: 'Сжать',
            install: 'Установить',
            install_with_alldebrid: 'Установить через AllDebrid',
            install_with_realdebrid: 'Установить через Real-Debrid',
            install_enable_rpi: 'Установить напрямую с URL-адреса',
            install_use_disk_cache: 'Включить кэширование на диске',
            ...
            error_installing_url: 'Произошла ошибка при установке URL',
        ...
        $translateProvider.translations('ua', {
            ...
            compress: 'Архівувати',
            install: 'встановити',
            install_with_alldebrid: 'Встановити через AllDebrid',
            install_with_realdebrid: 'Встановити через Real-Debrid',
            install_enable_rpi: 'Встановити безпосередньо з URL',
            install_use_disk_cache: 'Увімкнути кешування на диску',
            ...
            error_installing_url: 'Під час встановлення URL сталася помилка',
        ...
        $translateProvider.translations('tr', {
            ...
            compress: 'Sıkıştır',
            install: 'Düzenlemek',
            install_with_alldebrid: 'AllDebrid aracılığıyla yükleyin',
            install_with_realdebrid: 'Real-Debrid aracılığıyla yükleyin',
            install_enable_rpi: 'Doğrudan URL\'den yükleyin',
            install_use_disk_cache: 'Diskte önbelleğe almayı etkinleştir',
            ...
            error_installing_url: 'URL yüklenirken bir hata oluştu',
        ...
        $translateProvider.translations('fa', {
            ...
            compress: 'فشرده سازی',
            install: 'ثَبَّتَ',
            install_with_alldebrid: 'از طریق AllDebrid نصب کنید',
            install_with_realdebrid: 'از طریق Real-Debrid نصب کنید',
            install_enable_rpi: 'مستقیماً از URL نصب کنید',
            install_use_disk_cache: 'کش روی دیسک را فعال کنید',
            ...
            error_installing_url: 'هنگام نصب URL خطایی روی داد',
        ...
        $translateProvider.translations('pl', {
            ...
            install_with_alldebrid: 'Zainstaluj przez AllDebrid',
            install_with_realdebrid: 'Zainstaluj przez Real-Debrid',
            install_enable_rpi: 'Zainstaluj bezpośrednio z adresu URL',
            install_use_disk_cache: 'Włącz buforowanie na dysku',
            ...
            error_installing_url: 'Podczas instalowania adresu URL wystąpił błąd',
        ...
        $translateProvider.translations('it', {
            ...
            compress: 'Comprimi',
            install: 'Installare',
            install_with_alldebrid: 'Installa tramite AllDebrid',
            install_with_realdebrid: 'Installa tramite Real-Debrid',
            install_enable_rpi: 'Installa direttamente dall\'URL',
            install_use_disk_cache: 'Abilita la memorizzazione nella cache su disco',
            ...
            error_installing_url: 'Si è verificato un errore durante l\'installazione dell\'URL',
